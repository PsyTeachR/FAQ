...
If you are not able to install `r glossary("package", "packages")` from source, you are missing the build tools that are used to compile source code into files that the operating system can execute.
...
There will be a lot of red output in the RStudio `r glossary("console")`, but this is normal. 

![*Installing Packages*](images/mac05_installing.png)

After this, try to make a new `r glossary("R Markdown")` file and `r glossary("knit")` the demo file to html. You should be all set now.
